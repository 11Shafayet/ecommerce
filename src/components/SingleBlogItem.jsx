      ...
      <div className="flex flex-col gap-y-3 transition-all duration-500">
        <Link Link to={`/blog/${item._id}`}>
          <img
            ...
            alt=""
            className="img-fluid object-cover rounded hover:scale-105 duration-500 !h-[350px]"
          />

          <div>
            <h4 className="font-bold font-[poppins] hover:text-blue-600 duration-500 line-clamp-2 mt-3">
              {item.blogTitle}
            </h4>
